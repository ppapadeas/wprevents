...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'recurrence',
                      self.gf('recurrence.fields.RecurrenceModelField')(to=orm['recurrence.Recurrence'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.recurrence'
        db.delete_column(u'events_event', 'recurrence_id')
